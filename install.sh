...
dependencies=(bat eza fd fzf highlight lazygit nvm openssl python-pygments ranger ripgrep starship ttf-jetbrains-mono-nerd unzip xclip zsh zsh-autosuggestions zsh-history-substring-search zsh-syntax-highlighting)
